...
class ExchangeRatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exchange_rate" do
    assert_difference("ExchangeRate.count") do
      post exchange_rates_url, params: { exchange_rate: { base_symbol: @exchange_rate.base_symbol, date: @exchange_rate.date, rate: @exchange_rate.rate, target_symbol: @exchange_rate.target_symbol, timestamp: @exchange_rate.timestamp } }
    end
  ...
  test "should update exchange_rate" do
    patch exchange_rate_url(@exchange_rate), params: { exchange_rate: { base_symbol: @exchange_rate.base_symbol, date: @exchange_rate.date, rate: @exchange_rate.rate, target_symbol: @exchange_rate.target_symbol, timestamp: @exchange_rate.timestamp } }
